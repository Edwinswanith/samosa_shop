...
describe("transaction export", () => {
  it("creates a portable CSV with business dates and exact values", () => {
    ...
    expect(csv).toContain("businessDate,kind,reference,customer,quantity,unit,amount,paymentMethod");
    expect(csv).toContain("2026-08-27,inventory,potato,,15.5,kg,465.00,");
    expect(csv).toContain("2026-08-27,sale,samosa,university,400,piece,5600,Credit");
    expect(csv).toContain("2026-08-27,sale,kathi-roll,university,10,piece,650,Credit");
    expect(csv).toContain("2026-08-27,expense,Labour,,,,900.00,Cash");
    expect(csv).toContain("2026-08-25,payment,university,university,,,5773.50,UPI");
  });
});
